...
3. A clear **day-two operations** story: monitoring, metrics, and observability (e.g. Datadog segmented by region), admin tooling, disaster recovery, and compliance controls & audits.
